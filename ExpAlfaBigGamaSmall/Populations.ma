...
[acciones]
%Caso central
rule : {if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,-1)+(0,1)+(1,0)+(-1,0)+(-1)*(4*(0,0))))<0,
			0,
			if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,-1)+(0,1)+(1,0)+(-1,0)+(-1)*(4*(0,0))))>200,
				200,
				trunc((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,-1)+(0,1)+(1,0)+(-1,0)+(-1)*(4*(0,0))))
			   )
		  )
		}
		 100
...
rule : {if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,-1)+(0,1)+(1,0)+ (-1)*(4*(0,0))))<0,
			0,
			if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,-1)+(0,1)+(1,0)+(-1)*(4*(0,0))))>200,
				200,
				trunc(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,-1)+(0,1)+(1,0)+(-1)*(4*(0,0)))))
			   )
		  )
	 }
	  100
...
rule : {if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,1)+(1,0)+(-1,0)+(-1)*(4*(0,0))))<0,
			0,
			if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,1)+(1,0)+(-1,0)+(-1)*(4*(0,0))))>200,
			    200,
			    trunc(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,1)+(1,0)+(-1,0)+(-1)*(4*(0,0)))))
			   )
		  )
		}
		 100
...
rule : {if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,1)+(1,0)+(-1)*(4*(0,0))))<0,
			0,
			if(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,1)+(1,0)+(-1)*(4*(0,0))))>200,
				200,
				trunc(((0,0)+(0.2)*(0,0)+(-0.006)*power((0,0),2)+(0.18)*((0,1)+(1,0)+(-1)*(4*(0,0)))))
		      )
		   )
	   }	
	    100
